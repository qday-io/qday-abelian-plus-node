...
| Service | URL | Auth |
| --- | --- | --- |
| JSON-RPC (HTTP) | `http://localhost:8545` | None |
| JSON-RPC (WebSocket) | `ws://localhost:8546` | None |
| Engine API | `http://localhost:8551` | JWT (jwt.hex) |
| Beacon REST | `http://localhost:5052` | None |
